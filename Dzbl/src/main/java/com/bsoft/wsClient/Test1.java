...
public class Test1 {
    public static void main(String args[]){
        ...
        paramsMap.put("RegisteredYear", datestr.split("-")[0]);
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:oracle:thin:@192.46.112.30:1521/orcl", "phis_show", "phis_show");
...
//			ResultSet resultSet = null;
            ...
            if(QYSJ!=null){
                ...
                System.out.println("查询到记录条数："+RegisterInfoList.size());
                int failNum = 0;
...
//					}
                    ...
                    preparedStatement.setTimestamp(36, new java.sql.Timestamp((sf1.parse(UpdateTime)).getTime()));
                    preparedStatement.setString(37, CancelOperationName);
                    preparedStatement.setInt(38, 0);
                    preparedStatement.setString(39, CancelOperationDate);
                ...
                System.out.println("成功下载"+RegisterInfoList.size() + "条记录;过滤"+failNum+"条重复数据;花时" + (end - begin));
            }
